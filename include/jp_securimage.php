...
class jp_securimage {
	...
	function jp_securimage()
	{
		...
		$this->image_bg_color   = new Securimage_Color("#eee");
		$this->text_color       = new Securimage_Color(0x3d, 0x3d, 0x3d);
		$this->multi_text_color = array(new Securimage_Color("#008000"),
                        new Securimage_Color("#cc0033"),
                        new Securimage_Color("#9933ff"),
                        new Securimage_Color("#66660f"),
							   new Securimage_Color("#0000C0"),
							   new Securimage_Color("#008080"),
							   new Securimage_Color("#800000"),
                        new Securimage_Color("#808000"));
		$this->use_multi_text   = true;
		$this->use_transparent_text         = true;
		$this->text_transparency_percentage = 30;
		$this->num_lines            = 8;
		$this->line_color           = new Securimage_Color("#ccc");
